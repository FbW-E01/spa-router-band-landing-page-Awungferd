export default function Booking() {
    ...
    return <div className="booking">
        ...
        <ul className="contact">
			<li><h1>Contact</h1> </li>
            <li>
                Band: info@calibanmetal.com
            </li>
            <li>
                Booking: Kingstar Music GmbH Hamburg
            </li>
            <li>
                c/o Timo Birth - tb@kingstar-music.com
            </li>
            <li>
                Management: Tom Huschka - tom@doppeltsohart.com
            </li>
        </ul>
		</div>
...
<br />
			...
			<textarea name="message" id="message" cols="88" rows="5"></textarea><br />
